...
class Chat extends StatefulWidget {
  ...
  /// See [Message.showMessageSelection].
  final bool? showMessageSelection;

  /// See [Message.onMessageSelectionChanged].
    ...
    if (object is DateHeader) {
      ...
      if (message is types.SystemMessage) {
        ...
        final Widget msgWidget = Message(
          ...
          showMessageSelection: widget.showMessageSelection ?? false,
          onMessageSelectionChanged: widget.onMessageSelectionChanged,
